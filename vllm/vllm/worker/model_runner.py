...
class ModelRunner:
    ...
    def _prepare_prompt(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            #if len(loaded_kv_caches) == 0:
            #    loaded_kv_caches= [[None,None]] * len(self.model.model.layers)
            #self.model.model.old_kvs = loaded_kv_caches
            
            # TODO(Jiayi): need to pass in the must recompute indices
            # self.model.model.cache_fuse_metadata["missed_indices"] = None
    ...
    def execute_model(
        ...
        # Compute the logits.
        # HACK(Jiayi): Sampling metadata is modified here
